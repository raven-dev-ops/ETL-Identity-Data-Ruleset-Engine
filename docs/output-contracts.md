...
| Manual review queue | `data/review_queue/manual_review_queue.csv` | `review_id`, `left_id`, `right_id`, `score`, `reason_codes`, `top_contributing_match_signals`, `queue_status` | `queue_status` currently defaults to `pending`. |
