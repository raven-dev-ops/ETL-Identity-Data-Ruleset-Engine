# Post-v1.2.0 GitHub Issues Backlog

This file preserves the completed `v1.0.0`-`v1.2.0` customer-pilot
cycle as a historical record after the `v1.0.0` release. It is not the
active backlog source for new GitHub sync operations.

The current active backlog now lives in:

- `planning/active-github-issues-backlog.md`

Older historical backlog files remain available as read-only records:
