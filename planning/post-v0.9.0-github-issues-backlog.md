# Post-v0.9.0 GitHub Issues Backlog

This file preserves the completed `v0.7.0` through `v0.9.0` backlog
cycle as a historical record after the `v0.9.2` release. It is not the
active planning source of truth.
