...
- Search existing issues and review `planning/active-github-issues-backlog.md` before creating new work.
- Treat `planning/github-issues-backlog.md` and `planning/post-v0.1.0-github-issues-backlog.md` as closed historical records, not the active source for new work.
